...
import { Heart, Share2, ArrowLeft, Star, ShoppingCart, Check, Truck, RotateCcw, Shield } from "lucide-react";
        ...
        <div className="pd-layout">
          ...
          >
            ...
            <div className="pd-price-row">
              <span className="pd-price-main">₹{discountedPrice}</span>
              {product.discount > 0 && (
                <>
                ...
                <AnimatePresence mode="wait">
                  {addedToCart ? (
                    ...
                    <motion.span
                      ...
                      style={{ display: "flex", alignItems: "center", gap: 8 }}
                    >
                      <ShoppingCart size={18} /> Add to Cart — ₹{discountedPrice}
                    </motion.span>
                  )}
                </AnimatePresence>
              </button>
        ...
        <div className="pd-mobile-bar">
          ...
          >
            {addedToCart ? (
              ...
              <><ShoppingCart size={16} /> Add to Cart — ₹{discountedPrice}</>
            )}
          </button>
        </div>
