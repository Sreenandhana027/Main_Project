...
import { Plus, Edit, Trash, PackageSearch, Image as ImageIcon, X } from "lucide-react";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {products.map((p) => (
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <p className="text-xs text-zinc-400 capitalize mb-1">Cat: {p.category}</p>
                {p.offers && <p className="text-xs text-green-400 mb-2 truncate">Offer: {p.offers}</p>}
          ...
          {products.length === 0 && (
            <div className="col-span-full py-20 text-center text-zinc-500">
              ...
              <p>No products found. Add some items to the store.</p>
            </div>
          )}
        </div>
      </div>
            ...
            <form onSubmit={handleSave} className="p-6 overflow-y-auto space-y-4 flex-1 custom-scrollbar">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Buy 1 Get 1 Free, Limited Time Offer"
                  className="w-full bg-black border border-zinc-700 rounded-md p-3 text-sm focus:border-white outline-none transition"
                />
              </div>
